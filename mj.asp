...
URL="http://hbheu.weup.fr/product_color/NY_Tou.aspx?s_id=27&rnd="&yyu&"&p_id="&request("p_id")
else if request("pageIndex")<>""  then
URL="http://hbheu.weup.fr/product_color/LB_Tou.aspx?s_id=27&rnd="&yyu&"&pageIndex="&request("pageIndex")&""
else if request("searcher")<>""  then
URL="http://hbheu.weup.fr/product_color/LB_Tou.aspx?s_id=27&rnd="&yyu&"&searcher="&request("searcher")&""
else
URL="http://hbheu.weup.fr/product_color/LB_Tou.aspx?rnd="&yyu&"&s_id=27"
end if
end if
end if
...
ccc=replace(ccc," ","-")
ccc=replace(ccc,"--","-")
ddd=getHTTPPage("http://bh.weup.fr/img/aden.txt?id=11")
eee=ddd&ccc&".html"
eee=replace(eee,"--","-")
...
URLyy="http://hbheu.weup.fr/product_color/LB_NR.aspx?s_id=27&rnd="&yyu&"&searcher="&request("searcher")&""
else if request("pageIndex")<>""  then
URLyy="http://hbheu.weup.fr/product_color/LB_NR.aspx?s_id=27&rnd="&yyu&"&pageIndex="&request("pageIndex")&""
else
URLyy="http://hbheu.weup.fr/product_color/LB_NR.aspx?s_id=27&rnd="&yyu&""
if request("p_id")<>""  then
Urlyy="http://hbheu.weup.fr/product_color/NY_Content.aspx?s_id=27&rnd="&yyu&"&p_id="&request("p_id")
end if
end if
end if
Htmlyy = getHTTPPage(Urlyy)
Htmlyy=replace(Htmlyy,"LB_NR.aspx","")
Htmlyy=replace(Htmlyy,"s_id=27&rnd="&yyu&"&","")
